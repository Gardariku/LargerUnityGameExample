...
namespace World.PCD.StructureWFC
{
    public class WorldStructureSlotRenderer : MonoBehaviour
    {
        ...
        public WorldStructureSlotRendererOption OptionPrefab;

        private Dictionary<Module, WorldStructureSlotRendererOption> moduleToRenderer =
            new Dictionary<Module, WorldStructureSlotRendererOption>();

        public WorldStructureRenderer gridRenderer;
        ...
        public List<WorldStructureSlotRendererOption> OnCreated(WorldStructureConfig config, GenerationSpace space, Slot slot)
        {
            var createdOptions = new List<WorldStructureSlotRendererOption>();
            this.slot = slot;
            _space = space;
            this.config = config;
